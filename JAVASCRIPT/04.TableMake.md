...
view_stgup.fn_search = function(viewMake, list){
	var addHtml='';
	...
	$.each(list, function(i, v){
		...
		if(viewMake){
			addHtml += "<li " + (displayCheck==""?"class=\"liDisplay\"":diplayCheck)+"><div style=\"width:100%;\"><input type=\"checkbox\" id=\"viewOtpt" + (i+1) + "\" viewId=\"" + null2void(v.VIEW_ID) + "\" " + (v.USE_YN=="Y"?"checked=\"checked\"":"") + " "+ "\" viewNm=\"" + null2void(v.VIEW_NM) + "\" displayYn=\"" + null2void(v.DISPLAY_YN) + "\" onclickclass=\"" + null2void(v.ONCLICK) + "\" onclickdata=\"" + null2void(v.ONCLICKDATA) + "\" viewClass=\"" + null2void(v.VIEW_CLASS) + "\" viewStyle=\"" + null2void(v.VIEW_STYLE) + "</div></li>";
		}
...
view_stgup.makeTable = function(tableId, searchFn){
			...
			if (null2void(v.ONCLICK)!=""){
				if(null2void(v.ONCLICKDATA) != ""){
					...
					if(null2void(dat) != ""){
						...
						if(onclickyn != "N"){
							dat = "<a class=\""+ null2void(k.ONCLICK)+ "\" href=\"javascript:void(0);\" " + clickdata + "><font color=\"blue\" style=\"text-decoration:underline\">" + dat + "</font></a>";
						}
					}else{
						dat = "<a class=\""+null2void(k.ONCLICK)+"\" href=\"javascript:void(0);\" " + clickdata + "><font color=\"blue\" style=\"text-decoration:underline\">" + dat + "</font></a>";
					}
